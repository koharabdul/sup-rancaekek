...
function UploadFoto_Bendungan($fupload_name){
  //direktori gambar
  $vdir_upload = "../../foto_bendungan/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
function UploadFoto_Personil($fupload_name){
  //direktori gambar
  $vdir_upload = "../../foto_personil/";
  $vfile_upload = $vdir_upload . $fupload_name;
